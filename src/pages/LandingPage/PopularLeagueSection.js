...
const PopularLeagueSection = () => {
  ...
  const data = [
    {
      name: 'Elite',
      leagueLogo: require('../../assets/trout-square-1.png'),
      draftStart: new Date('2024-03-24').toISOString(),
      totalPlayers: 30,
      leagueType: 'Private',
      leagueLevel: 2,
      entryFee: 'SAMS 3500',
      prizePool: '0Edftrfdx12e34e5er6ff6tt6t',
    },
    {
      name: 'Premier',
      leagueLogo: require('../../assets/trout-square-1.png'),
    ...
    {
      name: 'Angels',
      leagueLogo: require('../../assets/beast-square-2.png'),
      draftStart: new Date('2024-03-24').toISOString(),
      totalPlayers: 29,
      leagueType: 'Private',
      leagueLevel: 1,
    ...
    {
      name: 'Warriors',
      leagueLogo: require('../../assets/ufafl-02-png-369-trans-0.png'),
      draftStart: new Date('2024-03-24').toISOString(),
      totalPlayers: 30,
      leagueType: 'Private',
      leagueLevel: 2,
