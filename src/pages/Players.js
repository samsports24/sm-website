                    ...
                    <div className="flex">
                        <div className="left-banner">
                            ...
                            <div className="text">
                                ...
                                <p>Based in Las Vegas NVTwitter:<span className="bold" style={{marginBottom:"11px"}}> @CircaTrout</span></p>
                                <p>Team Owner: <span className="bold"> Circa Sports Trout </span></p>
                            </div>
                        </div>
                        ...
                        <Row gutter={[30, 30]}>
                            {
                                PlayerData.map((data, i) => (
                                    <Col xs={24} md={12} lg={6} key={i}>
                                        <PlayerCard Image={data.Image} PlayerName={data.playerName} Owner={data.Owner} Positon={data.Positon} Age={data.Age} Date={data.Date}/>
                                    </Col>
                                ))
                            }
                        </Row>
