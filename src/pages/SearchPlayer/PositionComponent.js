    ...
    <div className='_positionBox'>
      ...
      <div>
        <div className='_borderLeft _hideBorderBottom' style={{ backgroundColor: '#010001' }}>
          <p style={{ fontSize: '7px' }} className='_fwd'>
            OFFENSE
          </p>
        </div>
        <div
      ...
      <div>
        <div className='_borderLeft _hideBorderBottom' style={{ backgroundColor: '#FF001B' }}>
          <p style={{ fontSize: '7px' }}>DEFENSE</p>
        </div>
        <div
      ...
      <div>
        ...
        <div
          onClick={() => handlePosition('K')}
          className={`${position === 'K' ? '_activePosition' : ''}`}
        >
          <p className='_k'>K</p>
        </div>
        <div
          onClick={() => handlePosition('P')}
          className={`${position === 'P' ? '_activePosition' : ''}`}
        >
          <p className='_p'>P</p>
        </div>
      </div>
