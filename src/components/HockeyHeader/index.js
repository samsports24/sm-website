...
const Header = () => {
  ...
  const teamFinancials = () => navigate('/team-financials')
        ...
        <div className='center_left'>
          ...
          <div className='button_and_team_box'>
            <div className='button_box'>
              <Button style={{ flex: 1 }}>League Standings</Button>
              <Button style={{ flex: 1 }}>Division Standings</Button>
            </div>
            <Button style={{ width: '100%' }}>Season Points</Button>
          </div>
        </div>
        <div className='center_right'>
          <div className='team_financials_box'>
            ...
            <div>
              ...
              <span>{`${teamSalary?.toLocaleString()} SP`}</span>
            </div>
            <div>
              <p>Team Salary Cap</p>
              <span>{`${teamSalary?.toLocaleString()} SP`}</span>
            ...
            <div>
              <p>Team Cap Left</p>
              <span>{`${(0 - teamSalary)?.toLocaleString()} SP`}</span>
            </div>
          </div>
        </div>
      </div>
