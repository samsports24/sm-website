    ...
    return (
        <div className="cost-container">
            ...
            <div className='card-body'>
                ...
                <div className='widgets-text'>
                    <p>To participate in this league, you must place a bid that meets the league’s minimum bidding requirement. It’s important to note that 75% of the draft order bids will directly contribute to your league’s prize pool, which will be distributed over the nex three years. This setup ensures a substantial prize pool for participants, adding to the excitement and competitiveness of the league.</p>
                </div>
